	            		...
	            		<tr>
	            			...
	            			<td>
	            				<select class="form-control" name="category" style="height: 40px; width: 150px;">
									<option value="all" ${dto.category == 'all' ? 'selected' : '' }>전체</option>
									<option value="product" ${dto.category == 'product' ? 'selected' : '' }>상품</option>
									<option value="shipping" ${dto.category == 'shipping' ? 'selected' : '' }>배송</option>
									<option value="refund" ${dto.category == 'refund' ? 'selected' : '' }>환불</option>
								</select>
	            			</td>
	            			<th colspan="2" style="width: 130px;">
	            				<div class="form-check-inline">
									<label class="form-check-label">
										비밀글 체크&nbsp;&nbsp;<input style="margin-top: 3px;" type="checkbox" name="secret" class="form-check-input" value="1" ${dto.secret == 1 ? 'checked' : '' }>
									</label>
								</div>
	            			</th>
	            		</tr>
