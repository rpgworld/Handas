...
function total_price() {
	...
	$('.total_price').html('총상품금액 &nbsp;&nbsp;' + total_price + '원');
}
</script>
</head>
<body>
        ...
        <div class="row">
            <div class="col-sm-12 item_read">
				<div class="item_image">
           		...
           		<div class="item_info">
           			<ul>
           				<li><h1>한다스 프리미엄 펜</h1></li>
           				<li class="item_price">2,500원</li>
           				<li class="item_count">
           					<div class="btn-group"> 
           				...
           				<li class="total_group">
           					<div>
								<h3 class="total_price" style="display: inline-block;">총상품금액 &nbsp;&nbsp;50,000원</h3>
